...
//    public String brand;
//
//    CarMultipleInheritance(String brand, int windows, int wheels, VehicleType type) {
//        this.brand = brand;
//        super(windows, type);
//        super(wheels);
//    }
//}
// MULTIPLE INHERITANCE IS NOT ALLOWED IN JAVA, FOR MULTIPLE INHERITANCE - USE INTERFACES.